...
import TabsComponent from '../../Component/TabsComponent/TabsComponent'; // Correct import for TabsComponent';
...
const { selectedOption } = ''; // Get the selected option from the query
const formCardColor = () => {
    ...
    <>
      ...
      */}
      <div className="min-h-full">
        ...
        <main>
        <div className={`shadow-md rounded-2xl mt-5  h-128  mb-4 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-90 max-w-3xl max-h-300 overflow-auto scale-100 ${formCardColor()}`}>
    <div className="flex min-h-full w-full flex-1 flex-col justify-start px-2 py-1 lg:px-10">
        <TabsComponent />
    </div>
</div>
